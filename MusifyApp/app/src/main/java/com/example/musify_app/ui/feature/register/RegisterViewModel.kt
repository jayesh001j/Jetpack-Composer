...
import com.example.musify_app.data.repository.AuthenticationRepository
...
class RegisterViewModel(
    ...
    private val musifySession: com.example.musify_app.data.MusifySession
) :
    ViewModel() {
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                when (val response = authenticationRepository.register(request)) {
                    is com.example.musify_app.data.network.Resource.Success -> {
                    ...
                    is com.example.musify_app.data.network.Resource.Error -> {
